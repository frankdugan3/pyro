defmodule Phlegethon.Resource.Info do
  ...
  alias Phlegethon.ResourceParams
  ...
  @doc ~S"""
  The label of the resource as defined in the `Phlegethon.Resource` extension, defaulting to a humanized version of the module name.
  ...
  def resource_label(resource) do
    case Spark.Dsl.Extension.get_opt(resource, [:phlegethon], :resource_label, nil) do
      nil ->
        resource
        |> Module.split()
        |> List.last()
  ...
  @doc ~S"""
  The default display mode of the resource as defined in the `Phlegethon.Resource` extension, defaulting to `:data_table`.
  ...
  def default_display_mode(resource),
    do: Spark.Dsl.Extension.get_opt(resource, [:phlegethon], :default_display_mode, :data_table)
  ...
  def read_actions(resource, actor, opts \\ []), do: actions_of_type(resource, :read, actor, opts)
  ...
  @doc ~S"""
  The label of the action as defined in the `Phlegethon.Resource` extension, defaulting to a humanized version of the action name.
  ...
  @doc ~S"""
  The default sort of resource for the given action, falling back to the default provided by the `Phlegethon.Resource` extension.
  ...
  def default_sort(resource, action) do
    case Ash.Query.for_read(resource, action).sort do
      [] ->
        with sort <- Spark.Dsl.Extension.get_opt(resource, [:phlegethon], :default_sort, nil),
  ...
  @doc """
  Returns the field defined in the `Phlegethon.Resource` extension as a default label, falling back to the first single-key identity of the resource, further falling back to the primary key if it's single-keyed.
  ...
  def default_foreign_label(resource),
    do:
      resource
      |> Spark.Dsl.Extension.get_opt([:phlegethon], :default_foreign_label, nil) ||
  ...
  @doc """
  Returns the form fields defined in the `Phlegethon.Resource` extension for the given action.
  ...
  @spec form_for(Ash.Resource.t(), atom()) :: [
          Phlegethon.Resource.Form.Field.t() | Phlegethon.Resource.Form.FieldGroup.t()
        ]
  def form_for(resource, action_name) do
    resource
    |> Spark.Dsl.Extension.get_entities([:phlegethon, :form])
    |> Enum.find(fn action ->
  ...
  #     @doc """
  #   Returns the specified form field defined in the `Phlegethon.Resource` extension for the given action.

  #   ## Examples

  #       iex> form_field(AttendanceRecord, :create, :label)
  #       %Phlegethon.Resource.Form.Field{name: :label}
  #   """
  ...
  @doc ~S"""
  The custom page module of the action as defined in the `Phlegethon.Resource` extension, if the resource is configured as a custom page.
  ...
  @doc ~S"""
  The page routing path of the resource as defined in the `Phlegethon.Resource` extension, if the resource is configured as a page.
  ...
  @doc ~S"""
  Return a boolean indicating if resource is a page as configured in the `Phlegethon.Resource` extension.
  ...
  # @doc ~S"""
  # Return a of resources configured as a page in the `Phlegethon.Resource` extension.
  ...
  @doc ~S"""
  The default table columns to display as defined in the `Phlegethon.Resource` extension, with fallback to all public fields.
  ...
  @doc ~S"""
  The default card fields to display as defined in the `Phlegethon.Resource` extension, with fallback to all public fields.
