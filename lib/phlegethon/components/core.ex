defmodule Phlegethon.Components.Core do
  ...
  overridable :style_for_kind, :string,
    values: :kinds,
  ...
  overridable :input_check_label_class, :class,
    required: true,
