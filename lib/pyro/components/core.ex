defmodule Pyro.Components.Core do
  ...
  ## Examples
      ...
      <.color_scheme_switcher theme="light" />
      <.color_scheme_switcher theme="dark" />
      <.color_scheme_switcher theme="system" />
  ...
  attr :theme, :atom,
    overridable: true,
    required: true,
    doc: "the theme used to initialize the color theme switcher"

  attr :label_system, :string,
    overridable: true,
    required: false,
    doc: "the label for the system theme"

  attr :label_dark, :string,
    overridable: true,
    required: false,
    doc: "the label for the dark theme"

  attr :label_light, :string,
    overridable: true,
    required: false,
    doc: "the label for the light theme"

  attr :icon_system, :string,
    overridable: true,
    required: false,
    doc: "the icon for the system theme"
  ...
  attr :icon_light, :string,
    overridable: true,
    required: false,
    doc: "the icon for the light theme"
