var Pyro = (() => {
  ...
  var hooks = {
    PyroFlashComponent: {
      mounted() {
        ...
        if (((_a = this.el.dataset) == null ? void 0 : _a.autoshow) !== void 0) {
    ...
    PyroAutocompleteComponent: {
      mounted() {
        ...
        const options = () => {
          ...
          if (listbox == null ? void 0 : listbox.children) {
  ...
  function nudge(el2) {
    ...
    hOffset = ((_a = el2.dataset) == null ? void 0 : _a.horizontalOffset) || 0;
    vOffset = ((_b = el2.dataset) == null ? void 0 : _b.verticalOffset) || 0;
  ...
  function resetHideTTL(self) {
    ...
    if (((_a = self.el.dataset) == null ? void 0 : _a.ttl) > 0) {
      self.countdown = (_b = self.el.dataset) == null ? void 0 : _b.ttl;
  ...
  return __toCommonJS(pyro_exports);
})();
