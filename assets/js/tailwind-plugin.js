...
module.exports = plugin.withOptions(function (options = {}) {
  return function ({
    ...
    const variantColors = Object.keys(theme('colors')).reduce((acc, key) => {
    ...
    if (options.addBase) {
      addBase({
        ...
        'html, body': {
          '@apply bg-white text-slate-900 dark:text-white dark:bg-gradient-to-tr dark:from-slate-900 dark:to-slate-800 h-full':
            {},
        },
